...
monstre::monstre(string name, int hpMax, int speed)  //Constructeur avec arguments de caract�ristiques du monstre
{
    this->name = name;
    this->hpMax = hpMax;
...
monstre::monstre(string name, int hpMax, int speed, vector<competence> allSkills) //Constructeur avec arguments de carac. et de comp�tences
{
    this->name = name;
    this->hpMax = hpMax;
    this->hpCurrent = this->hpMax;
...
vector<competence> monstre::getSkillVect() //Retourne le vecteur de comp�tence d'un monstre
{
...
int monstre::nbLigneFichier(string nomFichier) //Compte le nb de ligne du fichier pour cr�er l'identifiant unique d'un monstre
{
